// Spotify Frontend Clone - Interactive Features
// This script adds functionality to make your Spotify clone more dynamic

// Wait for the HTML document to fully load before running any JavaScript
document.addEventListener('DOMContentLoaded', function() {
    
 
     // Feature 1: Play Button Hover Effects
    ...
    cards.forEach(card => {
     ...
     // Feature 2: Create Playlist Button
    ...
    if (createPlaylistBtn) {
     ...
     // Feature 3: Browse Podcasts Button
    ...
    navArrows.forEach(arrow => {
     ...
     // Feature 10: Search Bar (Future Enhancement)
    // This shows how you could add search functionality
    // Note: You'll need to add a search input in HTML first
    ...
    if (rightPanel) {
     ...
     // Feature 12: Keyboard Shortcuts (Bonus)
    ...
    document.addEventListener('keydown', (event) => {
     ...
     // Feature 13: Add "Now Playing" Bar at Bottom
